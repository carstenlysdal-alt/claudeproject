...
for Y.dk rettet mod erhvervslæsere og SMV-ejere på Sjælland.
...
Etablere Y.dk som det primære erhvervsmedie for SMV-segmentet
på Sjælland — med redaktionel dybde, kommerciel bæredygtighed
og en teknologisk platform der skalerer.

## Kommerciel model

Under afklaring — tre kandidater:
1. Ren annoncering
2. Sponsoreret indhold
3. Hybrid-abonnement for virksomheder
