...
1. Åbn den relevante fil
2. Rediger teksten — behold struktur og labels
3. Sig: "opdater HTML fra [filnavn]" eller "opdater HTML fra content"
4. Claude opdaterer kun de berørte sektioner i HTML'en
